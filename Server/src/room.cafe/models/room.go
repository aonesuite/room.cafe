...
type Room struct {
	...
	RoomID          string               `json:"room_id"          gorm:"size:128;column:room_id"`       // RTC RoomName: 房间名称
	RoomToken       string               `json:"room_token"       gorm:"-"`                             // RTC RoomToken
	WhiteboardID    string               `json:"whiteboard_id"    gorm:"size:128;column:whiteboard_id"` // 白板房间 ID
